...
export class ClaudeSession extends EventEmitter {
  ...
  private async runQuery(prompt: string, resumeId?: string): Promise<void> {
    ...
    const opts: SDKOptions = {
      ...
      systemPrompt: { type: 'preset', preset: 'claude_code', append: 'Do not use CronCreate or any REPL scheduling tools. For waiting or polling (e.g. watching a build), use bash sleep in a loop.' },
